...
const PresenzButton = ({ config, callbacks, container, children = 'Verify Identity', className = '', disabled = false, theme = 'brand', }) => {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx("button", { type: "button", className: `presenz-button presenz-theme-${theme} ${className}`, onClick: startVerification, disabled: disabled || isLoading, children: isLoading ? (jsxRuntimeExports.jsx("span", { className: "presenz-loading", children: "Loading..." })) : (children) }), modalOpen && !container && (jsxRuntimeExports.jsx("div", { className: "presenz-modal-overlay", onClick: handleClose, children: jsxRuntimeExports.jsxs("div", { className: "presenz-modal-content", onClick: (e) => e.stopPropagation(), children: [jsxRuntimeExports.jsx("button", { className: "presenz-modal-close", onClick: handleClose, children: "\u00D7" }), errorMessage ? (jsxRuntimeExports.jsxs("div", { className: "presenz-error", children: [jsxRuntimeExports.jsx("p", { children: errorMessage }), jsxRuntimeExports.jsx("button", { onClick: cleanup, children: "Close" })] })) : (jsxRuntimeExports.jsx("div", { className: "presenz-iframe-wrapper", children: sessionUrlRef.current && (jsxRuntimeExports.jsx("iframe", { ref: iframeRef, src: sessionUrlRef.current, allow: "camera; microphone; fullscreen; autoplay", sandbox: "allow-scripts allow-same-origin allow-forms allow-popups allow-modals", title: "Presenz Identity Verification" })) }))] }) }))] }));
};
