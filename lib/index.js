...
const PresenzButton = ({ config, callbacks, container, children = 'Presenz Verify Identity Button', className = '', disabled = false, theme = 'brand', }) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("button", { type: "button", className: `presenz-button presenz-theme-${theme} ${className}`, onClick: startVerification, disabled: disabled || isLoading, children: isLoading ? (jsxRuntime.jsx("span", { className: "presenz-loading", children: "Loading..." })) : (children) }), modalOpen && !container && (jsxRuntime.jsx("div", { className: "presenz-modal-overlay", style: {
                    position: 'fixed',
                    inset: 0,
                    width: '100vw',
                    height: '100vh',
                    ...
                    padding: '15px',
                }, onClick: handleClose, children: jsxRuntime.jsxs("div", { style: {
                        flex: 1,
                        display: 'flex',
                        flexDirection: 'column',
                    }, onClick: (e) => e.stopPropagation(), children: [jsxRuntime.jsx("button", { style: {
                                width: '30px',
                                height: '30px',
                                display: 'flex',
                                flexDirection: 'column',
                                ...
                                color: 'black',
                                fontSize: '20px',
                            }, onClick: handleClose, children: "\u00D7" }), errorMessage ? (jsxRuntime.jsxs("div", { className: "presenz-error", children: [jsxRuntime.jsx("p", { children: errorMessage }), jsxRuntime.jsx("button", { onClick: cleanup, children: "Close" })] })) : (jsxRuntime.jsxs("div", { style: {
                                display: 'flex',
                                flexDirection: 'column',
                                flex: 1,
                                position: 'relative',
                            }, children: [isIframeLoading && (jsxRuntime.jsx("div", { style: {
                                        position: 'absolute',
                                        top: '50%',
                                        left: '50%',
                                        ...
                                        borderRadius: '12px',
                                            ...
                                            display: 'flex',
                                            gap: '5px',
                                        }, children: [0, 1, 2, 3, 4].map((index) => (jsxRuntime.jsx("div", { style: {
                                                width: '8px',
                                                height: '8px',
                                                borderRadius: '50%',
                                                ...
                                                opacity: 0.7,
                                            } }, index))) }) })), jsxRuntime.jsx("style", { children: `
                    @keyframes dotPulse {
                      0%, 60%, 100% {
                  ...
                  ` }), sessionUrlRef.current && (jsxRuntime.jsx("iframe", { style: {
                                        flex: 1,
